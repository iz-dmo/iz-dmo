...
**`🏠 property platforms`**, **`🛒 e-commerce systems`** , 
...
**`💹 financial markets, and risk management, aiming to fuse technology + finance into smart, data-driven business systems`**.

**`🔥 Building code. Studying markets. Engineering the future`**.
